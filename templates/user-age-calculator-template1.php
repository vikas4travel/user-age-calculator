...
<p>
	<div id="uac-widget">
		<div class="uac-heading">Calculate Your Age To Current Date</div>
		...
		<div class="submit-button-container">
			<button class="button uac-submit-button" onclick="uac_calculate_to_current_date( <?php echo intval( $random_number ); ?> )">Calculate</button>
		</div>
